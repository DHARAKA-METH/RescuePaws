...
public class UserServiceImpl implements UserService {
    ...
    public LoginRegisterResponse register(User user) {
        ...
        String jwtToken = jwtUtil.generateToken(newUser.getId(),newUser.getUsername(),newUser.getEmail(),newUser.getRole());
    ...
    public LoginRegisterResponse login(String email, String password, String role) {
        ...
        // generate jwt token
        String jwtToken = jwtUtil.generateToken(user.getId(),user.getUsername(),user.getEmail(),user.getRole());
