...
const dog = {
    ...
    description:
        "Found near Colombo Fort railway station. Appears to be 2–3 years old, male. Friendly temperament, responds to people. No collar or identification tag. Healthy weight, no visible injuries.",
    breed: "Golden Retriever",
    location: "Colombo Fort",
    reportedBy: "Ashan Silva",
    coordinates: "6.9344°N, 79.8428°E",
    emoji: "🐕",
    image: "https://images.unsplash.com/photo-1583511655857-d19b40a7a54e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        ...
        return (
            <div className="min-h-screen bg-surface flex items-center justify-center">
                <div className="card text-center p-10 max-w-sm mx-auto space-y-3">
                    ...
                    <Link href="/dogs" className="btn-primary inline-block mt-2">Back to listings</Link>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-surface px-4 py-6">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <Link
                    href="/dogs"
                    className="inline-flex items-center gap-1.5 text-ink-secondary text-sm
                ...
                <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] gap-5">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="card overflow-hidden p-0 animate-slide-up">
                            <div className="bg-navy-light h-52 flex items-center justify-center relative">
                                <span className="text-8xl select-none">{dog.image ? <ImageCart image={dog.image} /> : "🐕"}</span>
                                {/* status badge bottom-right */}
                                <span className={`absolute bottom-3 right-3 ${statusBadge[dog.status] ?? "badge-reported"} text-xs`}>
                                    {dog.status}
                                </span>
                            </div>
                            ...
                            <div className="p-5 space-y-3">
                                ...
                                <div className="grid grid-cols-3 gap-2 pt-1">
                                    {[
                                        ...
                                        { label: "Coordinates", value: dog.coordinates },
                                    ].map(({ label, value }) => (
                                        <div key={label}
                        ...
                        <div className="card overflow-hidden p-0 animate-slide-up"
                            ...
                            <div className="relative h-44 bg-[#dce8f0] overflow-hidden">
                                ...
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-full">
                                    <div className="w-8 h-8 bg-navy rounded-full border-2 border-white shadow-lg
                    ...
                    bg-white/80 backdrop-blur-sm rounded-lg px-2.5 py-1
                    text-[10px] text-ink-secondary font-medium border border-border whitespace-nowrap">
                                    {dog.coordinates}
                                </div>
                            </div>
                            ...
                            <div className="px-4 py-3 border-t border-border flex items-center justify-between gap-3">
                                <div className="flex items-center gap-1.5">
                                    <svg className="w-3.5 h-3.5 text-ink-hint" fill="none" stroke="currentColor"
                                ...
                                <button
                                    onClick={() => {
                                        // Use lat/lng if available, otherwise fall back to place name
                                        const lat = 6.9344;
                                        const lng = 79.8428;
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="card space-y-3 animate-slide-up" style={{ animationDelay: "80ms" }}>
                            ...
                            <button
                                onClick={handleSave}
                                className="w-full bg-rescued-text text-white rounded-xl px-5 py-2.5 text-sm
                           ...
                           transition-all duration-150 shadow-sm"
                            ...
                            <button
                                ...
                                className="w-full bg-reported-bg text-reported-text border border-reported-border
